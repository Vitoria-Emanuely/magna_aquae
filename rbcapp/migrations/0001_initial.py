# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2019-10-29 19:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_monitoramento', models.DateField(verbose_name='Data do Monitoramento')),
        ...
        migrations.AddField(
            model_name='monitoramento',
            name='imagem',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rbcapp.Imagem'),
        ),
        migrations.AddField(
            model_name='monitoramento',
            name='ponto_monitoramento',
